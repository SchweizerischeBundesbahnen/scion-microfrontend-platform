 ...
 */
test.describe('Activator Readiness', () => {

  test('should activate applications at platform startup and wait for them to finish activating, or continue if activation takes longer than the configured timeout (activatorLoadTimeout)', async ({testingAppPO, consoleLogs}) => {
