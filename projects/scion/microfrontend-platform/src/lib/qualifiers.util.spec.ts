...
describe('Qualifiers', () => {
  ...
  it('should validate a qualifier', () => {
    ...
    expect(Qualifiers.validateQualifier({objectEntry: {} as string}, {exactQualifier: true})).toMatch(/IllegalQualifierError/);
    expect(Qualifiers.validateQualifier({objectEntry: {} as string}, {exactQualifier: false})).toMatch(/IllegalQualifierError/);
  });
});
