...
describe('ParamMatcher', () => {
  ...
  it('should map default param values to optional params if not set', () => {
    // Optional params.
    ...
    // Deprecated params.
    expect(new ParamMatcher([{name: 'param1', required: false, deprecated: true, default: 'defaultValue1'}])
      .match(new Map()))
      .toEqual({
        matches: true,
        missingParams: [],
        unexpectedParams: [],
        deprecatedParams: [],
        params: new Map().set('param1', 'defaultValue1'),
      });
    ...
    expect(new ParamMatcher([{name: 'param1', required: false, deprecated: true, default: 'defaultValue1'}])
      ...
      .toEqual({
        ...
        missingParams: [],
        unexpectedParams: [],
        deprecatedParams: [{name: 'param1', required: false, deprecated: true, default: 'defaultValue1'}],
        params: new Map().set('param1', 'value1'),
      });
