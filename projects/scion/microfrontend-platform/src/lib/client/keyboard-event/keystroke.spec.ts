...
describe('Keystroke', () => {
  ...
  describe('fromString', () => {
    ...
    it('should parse \'keydown.s{preventDefault=true}\' keystroke', () => {
      expect(Keystroke.fromString('keydown.s{preventDefault=true}')).toEqual(new Keystroke('keydown', 's', undefined, {preventDefault: true}));
    });

    it('should parse \'keydown.s{preventDefault=false}\' keystroke', () => {
      expect(Keystroke.fromString('keydown.s{preventDefault=false}')).toEqual(new Keystroke('keydown', 's', undefined, {preventDefault: false}));
    });
