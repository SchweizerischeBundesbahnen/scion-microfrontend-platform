...
export enum BeanDestroyOrders {
   ...
   */
  CORE = Number.MAX_SAFE_INTEGER, // eslint-disable-line @typescript-eslint/prefer-literal-enum-member
  /**
   * Use for the {@link MessageBroker}.
   */
  BROKER = CORE - 1, // eslint-disable-line @typescript-eslint/prefer-literal-enum-member
  /**
   * Use for messaging-related beans.
   */
  MESSAGING = BROKER - 1, // eslint-disable-line @typescript-eslint/prefer-literal-enum-member
}
