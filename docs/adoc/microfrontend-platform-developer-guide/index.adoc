...
:typedoc-url: https://scion-microfrontend-platform-api-v{revnumber-dasherized}.now.sh
:testing-app-url: https://scion-microfrontend-platform-testing-app1-v{revnumber-dasherized}.now.sh
