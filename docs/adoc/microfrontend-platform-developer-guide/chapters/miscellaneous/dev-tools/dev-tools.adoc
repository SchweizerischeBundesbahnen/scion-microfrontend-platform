...
IMPORTANT: Note that we need to disable some checks for the SCION DevTools to have access to private and inactive capabilities. We recommend not to do this for regular micro applications.
