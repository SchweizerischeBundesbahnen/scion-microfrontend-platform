...
You register interceptors with the bean manager when starting the host application. Interceptors can be registered only in the host application. They are invoked in registration order.
