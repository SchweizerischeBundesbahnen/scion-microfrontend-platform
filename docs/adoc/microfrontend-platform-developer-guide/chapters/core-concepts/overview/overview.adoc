...
If the host application wants to interact with either the platform or the micro applications, the host application has to register itself as a micro application. The host application has no extra privileges compared to other micro applications.
