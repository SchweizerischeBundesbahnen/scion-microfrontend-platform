...
With SCION Microfrontend Platform, you can integrate any web page as a microfrontend using an iframe. If the microfrontend wants to interact with other microfrontends, you need to register its web app as a micro application in the host application.
