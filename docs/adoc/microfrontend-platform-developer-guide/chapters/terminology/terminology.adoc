...
+
The host app starts the <<terminology:platform,platform>> host and registers <<terminology:micro-application,micro applications>>. As with micro applications, the host can provide a manifest to contribute behavior.
