...
import { Beans, ContextService, FocusMonitor, mapToBody, MessageClient, MicroApplicationConfig, MicrofrontendPlatform, OUTLET_CONTEXT, OutletContext } from '@scion/microfrontend-platform';
